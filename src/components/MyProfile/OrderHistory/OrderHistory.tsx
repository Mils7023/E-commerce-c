      ...
      <div className={`${styles.profile_body} common-profile-shadow mt-3`}>
        ...
        {!getOrdersLoading && (
          ...
          >
                ...
                {OrderItems &&
                  OrderItems?.map((order) =>
                    order?.status != "Shipping" ? (
                      <div key={order?.id} className={styles.order_table_body}>
                        <div className={`${styles.order_table_body_title}`}>
                          <div className="row">
                            <div className="col-md-10 col-9 d-flex gap-2 gap-xl-3 align-items-center">
                              <span
            ...
            >
              <Tabs
                defaultActiveKey="order_reviews1"
                id="order_history_review_navs"
                className="order_history_review_navs pt-4"
              >
                <Tab
                  eventKey="order_reviews1"
                  title="To Be Reviewed"
                  className="order_history_review_navs"
                >
                  <div className={`${styles.order_table} mt-4`}>
                    <div
                      className={`d-sm-block d-none ${styles.order_table_header}`}
                              ...
                              >
                                ...
                                >
                                  <span
                                    className={`${styles.order_table_product_name} black_text font_rg pb-sm-1 d-inline-block line-clamp line-clamp2`}
                                  >
                                    Unicorn birthday party personalized icing
                                    edible costco cake topper r2-uz
                                  </span>
                                  <span
                                    className={`${styles.order_table_product_name} black_text font_rg line-clamp line-clamp2`}
                                  >
                                    Image type: a4 rectangle cake (8 inch x 11
                                    inch)
                                  </span>
                                </div>
                              </div>
...

{
  ...
  <div className={styles.order_table_body}>
    <div className={`${styles.order_table_body_title}`}>
      <div className="row">
        <div className="col-md-10 col-9 d-flex gap-2 gap-xl-3 align-items-center">
          <span className={`${styles.order_table_bd} black_text font_md`}>
            ORDER : NS1587665447
          </span>
          <span className={`${styles.order_table_bd} black_text font_md`}>
            Sep 11, 2024
...
//                 className={`${styles.order_table_product_name} black_text font_rg pb-sm-1 d-inline-block line-clamp line-clamp2`}
//               >
//                 Unicorn birthday party personalized icing edible costco cake
//                 topper r2-uz
//               </span>
//               <span
//                 className={`${styles.order_table_product_name} black_text font_rg line-clamp line-clamp2`}
